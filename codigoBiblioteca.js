...
"Las Cronicas de Narnia: El Principe Caspian","Cinco Semanas en Globo"];
...
"Ficcion Aventura","Ficcion Aventura"];
const ListaEdad1=[8,8,8,12,10,11,8,15,12,12,
				  14,13,14,13,12,10,13,12,12,12,
				  12,10];
const ListaEdad2=[10,10,10,14,12,13,10,17,14,14,
...
"Narnia-el-principe-caspian.png","cincoSemanasEnGlobo.jpg"];
...
"https://drive.google.com/file/d/1Vcgv4xGxueIOTP-CiGbKM_l_qH0oHbn-/view?usp=sharing","https://drive.google.com/file/d/1O_QkrHedJeAsvxbZ_PYp2tzH8YwyfpPO/view?usp=sharing"];
...
for (var i = 0; i <lista.length; i++) {
	...
	else if((edad1>=12 && edad1<=14) || (edad2>=12 && edad2<=14)){
